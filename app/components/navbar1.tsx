...
export default function Navigation1() {
    ...
    return (
        // Wrapping the entire component with ClerkProvider without the frontendApi prop
      
          <section className="overflow-hidden">
            {/* Top Section - Contact and Social Media Links */}
            <nav className="bg-custom-dark-green-0 w-full flex flex-col sm:flex-row justify-between items-center px-4 py-2 sm:px-16 sm:py-1">
            ...
            <div className="w-full h-[58px] flex items-center bg-white px-4 sm:px-8">
              ...
              <div className="flex items-center ml-auto sm:hidden">
                <button onClick={toggleMenu} className="text-black" aria-label="Toggle navigation menu" type="button">
              ...
              <nav className="hidden sm:flex items-center justify-between w-full ml-8">
                ...
                {/* Clerk Sign-In and Register */}
                <div className="flex items-center space-x-8">
                 
                     
                        <Image src="/but.png" alt="button" width={12} height={12} className="hover:opacity-80 transition-opacity" />
                        <p className="text-custom-blue font-bold text-sm font-Montserrat ml-2 hover:text-custom-blue-dark transition-all duration-300">
                          Login/
                        </p>
